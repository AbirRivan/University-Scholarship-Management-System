<html lang="en">
  ...
  <body> 
	...
	<section id="header">
		<div class="row">  
			<div class="col-md-2" style="font-size: 30px;color:#004080;"> Scolarship Management System </div>
			<div class="col-md-10" style="text-align: right"> 
			<a href="Adminpanel.php"> Back </a>
			<a href="insert_Scholarship.php" style="margin-left: 20px;"> Add Scholarship  </a>
			<a href="search_scholarship.php" style="margin-left: 20px;"> Search Scholarship  </a>
			<a href="Scholarship_category.php" style="margin-left: 20px;"> Scholarship Category  </a>
	...
	<section id = "section1">
		...
		<div style="margin-left:0%; margin-right:0%; margin-top:60px; margin-bottom:70px;text-align:center;background: #dfff80;">
