<html lang="en">
  ...
  <body> 
	...
	<section id = "section1">
		<div class="title"> Find out Application Status  </div>
		...
		error_reporting(0);
			...
			if(isset($_POST['search'])){
				...
				$sql = "SELECT Scholarship_ID,Student_name, Status,Reason from scholarship WHERE Scholarship_ID LIKE '%$searchKey%'";	
			}else
			$sql = " ";
